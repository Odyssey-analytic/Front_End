  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.box}>
        <Link
          to="/login"
          className={`text-muted d-block text-end ${styles.backToLogin}`}
        >
          ← بازگشت به صفحه ورود
        </Link>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <p className={styles.infoText}>
            ما یک پیام برای تنظیم یا بازیابی رمز عبور جدید برایتان ارسال خواهیم
            کرد.
          </p>
