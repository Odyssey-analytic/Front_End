...
const AverageFPSConsumer = ({selectedTime}) => {
  ...
  // );
    sseRef.current = new EventSource(
    `https://odysseyanalytics.ir/api/kpi/sse/AverageFPS?product_id=${gameId}&start_time=${selectedTime}&update_interval=${interval}`
  );
...
export default AverageFPSConsumer;
